<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="键" align="center" prop="configKey" width="200"/>
      ...
      <el-table-column label="1:显示 0：不显示" align="center" prop="isFront" /> -->
    ...
    <el-dialog :title="title" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="键" prop="configKey">
          <el-input v-model="form.configKey" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        ...
        <!-- <el-form-item label="1:显示 0：不显示" prop="isFront">
          <el-input v-model="form.isFront" placeholder="请输入1:显示 0：不显示" />
        </el-form-item> -->
      </el-form>
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig } from "@/api/shop/config";
