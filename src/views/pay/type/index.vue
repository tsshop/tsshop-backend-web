<template>
  <div class="app-container">
    ...
    >
      ...
      <!-- <el-form-item label="支付方式" prop="typeName">
        <el-input
          v-model="queryParams.typeName"
          placeholder="请输入支付方式"
          clearable
    ...
    >
      ...
      <el-table-column label="支付logo" align="center" prop="logo" width="200">
      ...
      <el-table-column label="支付方式" align="center" prop="typeName" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="支付方式" prop="type">
          <!-- <el-input v-model="form.type" placeholder="示例 ALI_PAY_H5" /> -->
          <el-select
            @change="changeType"
            v-model="form.type"
            placeholder="请选择类型"
        ...
        <!-- <el-form-item label="支付方式" prop="typeName">
          <el-input v-model="form.typeName" placeholder="请输入支付方式" />
        </el-form-item> -->
      </el-form>
...
export default {
  ...
  methods: {
    changeType(e) {
      this.form.typeName = this.typeObj[e] || "";
    },
    // 查询支付类型
    getPayType() {
      this.request({
